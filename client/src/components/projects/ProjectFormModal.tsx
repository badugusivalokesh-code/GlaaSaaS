  ...
  return (
    ...
    >
      <div
        ...
        ref={dialogRef}
        className="glass-surface w-full max-w-lg p-6"
      >
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <select
                ...
                disabled={isSubmitting}
                className="h-11 rounded-secondary border border-border-glass-secondary bg-bg-secondary px-3 text-body-md text-fg-primary backdrop-blur-glass focus-visible:border-brand disabled:cursor-not-allowed disabled:opacity-50"
              >
