...
export function DashboardShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <aside className="hidden w-72 shrink-0 border-r border-border-bounds bg-bg-primary/60 backdrop-blur-glass xl:block">
        <Sidebar />
      </aside>
      ...
      <aside className="hidden w-20 shrink-0 border-r border-border-bounds bg-bg-primary/60 backdrop-blur-glass md:flex xl:hidden">
        <Sidebar collapsed />
      </aside>
