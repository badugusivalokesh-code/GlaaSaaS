  ...
  return (
    ...
    >
      <button
        ...
        className="relative rounded-full p-2.5 text-fg-secondary hover:bg-bg-quaternary hover:text-fg-primary"
      >
        <Bell size={18} />
        {hasUnread && (
  ...
  return (
    <label className="relative min-w-0 flex-1">
      ...
      <input
        ...
        className="h-11 w-full rounded-full border border-border-glass-secondary bg-bg-secondary pl-10 pr-10 text-body-md text-fg-primary placeholder:text-fg-tertiary backdrop-blur-glass focus-visible:border-brand"
      />
      {value && (
        <button
          type="button"
          ...
          className="absolute right-2.5 top-1/2 -translate-y-1/2 rounded-full p-1 text-fg-tertiary hover:bg-bg-quaternary hover:text-fg-primary"
        >
          <X size={14} />
        </button>
      )}
  ...
  return (
    ...
    >
      <button
        ...
        className="flex h-9 w-9 items-center justify-center rounded-full text-label-sm2 text-white shadow-light-default"
      >
        {initials(user.name)}
      </button>
      {isOpen && (
        ...
        >
          ...
          <button
            ...
            className="flex w-full items-center gap-2 rounded-secondary px-2 py-2 text-left text-body-sm text-fg-secondary hover:bg-bg-quaternary hover:text-fg-primary disabled:cursor-not-allowed disabled:opacity-50"
          >
...
export function Topbar({ onOpenMenu }: { onOpenMenu: () => void }) {
  return (
    <header className="sticky top-0 z-30 flex min-w-0 items-center gap-2 border-b border-border-bounds bg-bg-primary/70 px-3 py-3 backdrop-blur-glass sm:gap-3 sm:px-6">
      <button
        type="button"
        onClick={onOpenMenu}
        aria-label="Open menu"
        className="flex-shrink-0 rounded-secondary p-2 text-fg-secondary hover:bg-bg-quaternary hover:text-fg-primary md:hidden"
      >
        <Menu size={20} />
      </button>
